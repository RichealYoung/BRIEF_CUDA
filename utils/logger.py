...
class MyLogger():
    ...
    def dir_init(self,):
        self.chunks_dir = opj(self.project_dir, 'chunks')
        self.opts_dir = opj(self.project_dir, 'opts')
        self.compressed_dir = opj(self.project_dir, 'compressed')
        self.decompressed_dir = opj(self.project_dir, 'decompressed')
        self.decompressed_chunks_dir = opj(self.decompressed_dir, 'chunks')
        self.script_dir = opj(self.project_dir, 'script')
        self.stdout_dir = opj(self.project_dir, 'stdout')
        os.mkdir(self.chunks_dir)
        os.mkdir(self.opts_dir)
        os.mkdir(self.compressed_dir)
        os.mkdir(self.decompressed_dir)
        os.mkdir(self.decompressed_chunks_dir)
